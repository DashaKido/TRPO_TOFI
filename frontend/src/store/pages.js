export let PagesDataStore = {
    ...
    getters: {
        ...
        getShowEditUserPage(state) {
            return state.showEditUserPage;
        },
        ...
        getShowEditEventPage(state) {
            return state.showEditEventPage
        },
    ...
    mutations: {
        ...
        setShowEditUserPage(state, new_val) {
            state.showEditUserPage = new_val;
        },
        ...
        setShowEditEventPage(state, new_val) {
            state.showEditEventPage = new_val;
        },
    ...
    actions: {
        closeAllPages({commit}) {
            ...
            commit('setShowEditUserPage', false);
            ...
            commit('setShowEditEventPage', false)
